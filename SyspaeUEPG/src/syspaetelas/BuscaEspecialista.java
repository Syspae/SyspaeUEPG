...
public class BuscaEspecialista extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        if (tblBuscaAluno.getColumnModel().getColumnCount() > 0) {
            tblBuscaAluno.getColumnModel().getColumn(0).setMinWidth(200);
            tblBuscaAluno.getColumnModel().getColumn(0).setPreferredWidth(200);
            tblBuscaAluno.getColumnModel().getColumn(1).setPreferredWidth(400);
            tblBuscaAluno.getColumnModel().getColumn(2).setMinWidth(300);
            tblBuscaAluno.getColumnModel().getColumn(2).setPreferredWidth(300);
        }
