...
public class CadastroAnamnese extends javax.swing.JFrame {
    ...
    // Função para calcular a idade do aluno utilizando a função between da classe Period
    private void idade(){
    ...
    private void buscaAlunos(int id){
        ...
        ResultSet rs = con.executaBusca("Select nome from aluno where idaluno = "+id+"");
        try {
            while(rs.next()){
    ...
    private void buscaNascimento(){   
        Conexao con = new Conexao();
        ResultSet rs = con.executaBusca("Select data_nascimento from aluno where nome like '"+cmbbxNome.getText()+"'");
        try {
            while(rs.next()){
