 ...
 * @author carlo
 */
public class TelaHistoricoAtendimento extends javax.swing.JFrame {

    /**
     * Creates new form TelaHistoricoAtendimento
     */
    public TelaHistoricoAtendimento() {
        initComponents();
    ...
    private void btn03CancelarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn03CancelarActionPerformed
        ...
        TelaHistoricoAtendimento.this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaHistoricoAtendimento.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaHistoricoAtendimento().setVisible(true);
            }
        });
    }
