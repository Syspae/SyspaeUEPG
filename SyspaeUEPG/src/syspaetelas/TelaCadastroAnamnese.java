 ...
 * @author carlo
 */
public class TelaCadastroAnamnese extends javax.swing.JFrame {

    /**
     * Creates new form TelaCadastroAnamnese
     */
    public TelaCadastroAnamnese() {
        initComponents();
    ...
    private void btnCancelarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCancelarActionPerformed
        // TODO add your handling code here:
        TelaCadastroAnamnese.this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaCadastroAnamnese.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaCadastroAnamnese().setVisible(true);
            }
        });
    }
